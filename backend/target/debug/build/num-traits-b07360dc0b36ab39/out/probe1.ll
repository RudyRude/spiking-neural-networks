; ModuleID = 'probe1.3658d3087fc9b909-cgu.0'
source_filename = "probe1.3658d3087fc9b909-cgu.0"
...
define void @_RNvCs4FhPIfxocAL_6probe15probe() unnamed_addr #0 {
start:
; call <f64>::total_cmp
  %_1 = call i8 @_RNvMNtCsglnevYzBJLN_4core3f64d9total_cmpCs4FhPIfxocAL_6probe1(ptr align 8 @alloc_f93507f8ba4b5780b14b2c2584609be0, ptr align 8 @alloc_ef0a1f828f3393ef691f2705e817091c) #3
  ret void
}

; <f64>::total_cmp
; Function Attrs: inlinehint uwtable
define internal i8 @_RNvMNtCsglnevYzBJLN_4core3f64d9total_cmpCs4FhPIfxocAL_6probe1(ptr align 8 %self, ptr align 8 %other) unnamed_addr #1 {
start:
...
attributes #1 = { inlinehint uwtable "frame-pointer"="all" "probe-stack"="inline-asm" "target-cpu"="penryn" }
...
!1 = !{!"rustc version 1.95.0-nightly (d940e5684 2026-01-19)"}
